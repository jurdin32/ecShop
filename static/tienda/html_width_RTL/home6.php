...
.content-main .container-fluid {
  padding: 0; }
.content-main .so-spotlight1 .owl-loaded .owl-nav div {
  width: 90px;
  height: 90px;
  line-height: 90px;
  display: block;
  ...
  text-align: center;
  border-radius: 50%; }
  .content-main .so-spotlight1 .owl-loaded .owl-nav div:after {
    font-size: 1.5em; }
  .content-main .so-spotlight1 .owl-loaded .owl-nav div:hover {
    background: #f02034; }
    .content-main .so-spotlight1 .owl-loaded .owl-nav div:hover:after {
      color: #fff; }
.content-main .so-spotlight1 .owl-loaded .owl-nav .owl-prev:after {
  content: "\f105";
  font-family: FontAwesome; }
.content-main .so-spotlight1 .owl-loaded .owl-nav .owl-next:after {
  content: "\f104";
  font-family: FontAwesome; }
.content-main .so-spotlight1 .owl-loaded .owl-nav div {
  ...
  .content-main .so-spotlight1 .owl-loaded .owl-nav div:hover {
    ...
    .content-main .so-spotlight1 .owl-loaded .owl-nav div:hover:after {
      color: #f02034; }
.content-main .so-spotlight1 .owl-loaded .owl-nav .owl-next {
  left: 20px; }
.content-main .so-spotlight1 .owl-loaded .owl-nav .owl-prev {
  right: 20px; }
.content-main .so-spotlight2 .policy-detail .banner-policy .policy {
  width: 33.3333%;
  float: right;
  display: block;
  text-align: center;
  padding: 50px 0; }
  .content-main .so-spotlight2 .policy-detail .banner-policy .policy .service-info h3 {
    font-size: 15px;
    font-weight: 600;
    color: #333333; }
  .content-main .so-spotlight2 .policy-detail .banner-policy .policy .service-info p {
    color: #777777; }
  .content-main .so-spotlight2 .policy-detail .banner-policy .policy .icon-policy {
    height: 54px;
    width: 100%;
    opacity: 0.5; }
  .content-main .so-spotlight2 .policy-detail .banner-policy .policy:hover {
    box-shadow: 0 0 30px rgba(0, 0, 0, 0.1); }
    .content-main .so-spotlight2 .policy-detail .banner-policy .policy:hover .icon-policy {
      opacity: 1; }
  .content-main .so-spotlight2 .policy-detail .banner-policy .policy:last-child {
    border: none; }
.content-main .so-spotlight2 .policy-detail .banner-policy .policy1 .icon-policy {
  background: url(../img/theme/icon/home-3/icon-1.jpg) no-repeat center; }
.content-main .so-spotlight2 .policy-detail .banner-policy .policy2 .icon-policy {
  background: url(../img/theme/icon/home-3/icon-2.jpg) no-repeat center; }
.content-main .so-spotlight2 .policy-detail .banner-policy .policy3 .icon-policy {
  background: url(../img/theme/icon/home-3/icon-3.jpg) no-repeat center; }
.content-main .so-spotlight3 {
  text-align: center;
  padding: 60px 0;
  background: #fafafa; }
  .content-main .so-spotlight3 .owl-carousel .owl-stage {
    padding-bottom: 1px; }
  .content-main .so-spotlight3 .owl-carousel .product-layout {
    padding-top: 20px;
    padding-bottom: 1px; }
    .content-main .so-spotlight3 .owl-carousel .product-layout:hover .product-img {
      background: rgba(0, 0, 0, 0.3);
      display: block;
      overflow: hidden; }
    .content-main .so-spotlight3 .owl-carousel .product-layout:hover .product-item-container .left-block .hover-1 ul li {
      bottom: 0; }
    .content-main .so-spotlight3 .owl-carousel .product-layout:hover .right-block button {
      background: #333333;
      border-color: #333333; }
      .content-main .so-spotlight3 .owl-carousel .product-layout:hover .right-block button span {
        color: #fff !important; }
    .content-main .so-spotlight3 .owl-carousel .product-layout:hover .right-block .caption h4 a {
      color: #f02034; }
    .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container {
      border: none; }
      .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block {
        position: relative;
        border: 1px solid #e5e5e5;
        border-radius: 0;
        padding: 0; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .product-image-container .product-img {
          display: block;
          overflow: hidden; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .product-image-container .product-img img {
            width: 100%; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .product-image-container .product-img:before {
            background-color: inherit;
            position: absolute;
            top: 0;
            bottom: 0;
            ...
            height: 100%;
            transition: all 0.5s; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .new {
          position: absolute;
          width: 45px;
          height: 45px;
          border-radius: 100px;
          ...
          background: #333333;
          text-transform: uppercase; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .sale {
          position: absolute;
          width: 45px;
          height: 45px;
          border-radius: 100px;
          ...
          top: 10px;
          left: 10px; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 {
          width: 100%;
          position: absolute;
          bottom: 0;
          left: 0; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul {
            padding: 0;
            text-align: center;
            display: block;
            overflow: hidden; }
            .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul li {
              list-style: none;
              display: inline-block;
              width: 40px;
              height: 40px;
              ...
              border-radius: 50%;
              float: none; }
              .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul li a {
                font-size: 1.5em;
                transition: none;
                height: 40px;
                display: block;
                ...
                color: #222222;
                border-radius: 50%; }
              .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul li:hover a {
                background: #f02034;
                color: #fff; }
            .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul .icon-cart {
              transition: opacity 0; }
            .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul .icon-heart {
              transition: opacity 0.5s; }
            .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul .icon-exchange {
              transition: opacity 1s; }
            .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .left-block .hover-1 ul .icon-search {
              transition: opacity 1.5s; }
      .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block {
        padding-top: 5px; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block h4 {
          margin-bottom: 10px;
          margin-top: 10px; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block h4 a {
            font-size: 14px;
            color: #444444; }
            .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block h4 a:hover {
              color: #f02034; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .ratings {
          line-height: 30px; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .ratings span i {
            color: #222222; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .ratings .gray i {
            color: #cccccc; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .price {
          margin: 10px 0 15px; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .price span {
            font-size: 18px;
            color: #ff5555;
            font-weight: 500; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .price .price-old {
            font-size: 14px;
            text-decoration: line-through;
            color: #777777; }
        .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .button-group button {
          border-radius: 0; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .button-group button:hover {
            background: #333333;
            border-color: #333333; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .button-group button:active:focus {
            background: #333333;
            border-color: #333333; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .button-group button:active {
            background: #333333;
            border-color: #333333; }
          .content-main .so-spotlight3 .owl-carousel .product-layout .product-item-container .right-block .button-group button:focus {
            background: #333333;
            border-color: #333333; }
.content-main .so-spotlight4 .block-banner, .content-main .so-spotlight4 .block-product {
  width: 50%;
  float: right; }
.content-main .so-spotlight4 .block-product {
  text-align: center;
  padding: 0 20px; }
  .content-main .so-spotlight4 .block-product hr {
    border-top: 1px solid #f02034;
    width: 120px;
    position: relative; }
    .content-main .so-spotlight4 .block-product hr:after {
      content: "+";
      font-family: FontAwesome;
      color: #f55;
      font-weight: 700;
  ...
  .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout {
    padding-top: 20px;
    padding-bottom: 1px; }
    .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout:hover .product-img {
      background: rgba(0, 0, 0, 0.3);
      display: block;
      overflow: hidden; }
    .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout:hover .product-item-container .left-block .hover-1 ul li {
      bottom: 0; }
    .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout:hover .right-block button {
      background: #333333;
      border-color: #333333; }
      .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout:hover .right-block button span {
        color: #fff !important; }
    .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout:hover .right-block .caption h4 a {
      color: #f02034; }
    .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container {
      border: none; }
      .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block {
        position: relative;
        border: 1px solid #e5e5e5;
        border-radius: 0;
        padding: 0; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .product-image-container .product-img {
          display: block;
          overflow: hidden; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .product-image-container .product-img img {
            width: 100%; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .product-image-container .product-img:before {
            background-color: inherit;
            position: absolute;
            top: 0;
            bottom: 0;
            ...
            height: 100%;
            transition: all 0.5s; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .new {
          position: absolute;
          width: 45px;
          height: 45px;
          border-radius: 100px;
          ...
          background: #333333;
          text-transform: uppercase; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .sale {
          position: absolute;
          width: 45px;
          height: 45px;
          border-radius: 100px;
          ...
          top: 10px;
          left: 10px; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 {
          width: 100%;
          position: absolute;
          bottom: 0;
          left: 0; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul {
            padding: 0;
            text-align: center;
            display: block;
            overflow: hidden; }
            .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul li {
              list-style: none;
              display: inline-block;
              width: 40px;
              height: 40px;
              ...
              border-radius: 50%;
              float: none; }
              .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul li a {
                font-size: 1.5em;
                transition: none;
                height: 40px;
                display: block;
                ...
                color: #222222;
                border-radius: 50%; }
              .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul li:hover a {
                background: #f02034;
                color: #fff; }
            .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul .icon-cart {
              transition: opacity 0; }
            .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul .icon-heart {
              transition: opacity 0.5s; }
            .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul .icon-exchange {
              transition: opacity 1s; }
            .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul .icon-search {
              transition: opacity 1.5s; }
      .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block {
        padding-top: 5px; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block h4 {
          margin-bottom: 10px;
          margin-top: 10px; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block h4 a {
            font-size: 14px;
            color: #444444; }
            .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block h4 a:hover {
              color: #f02034; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .ratings {
          line-height: 30px; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .ratings span i {
            color: #222222; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .ratings .gray i {
            color: #cccccc; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .price {
          margin: 10px 0 15px; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .price span {
            font-size: 18px;
            color: #ff5555;
            font-weight: 500; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .price .price-old {
            font-size: 14px;
            text-decoration: line-through;
            color: #777777; }
        .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .button-group button {
          border-radius: 0; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .button-group button:hover {
            background: #333333;
            border-color: #333333; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .button-group button:active:focus {
            background: #333333;
            border-color: #333333; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .button-group button:active {
            background: #333333;
            border-color: #333333; }
          .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .right-block .button-group button:focus {
            background: #333333;
            border-color: #333333; }
    .content-main .so-spotlight4 .block-product .owl-carousel .item .product-layout .product-item-container .left-block .hover-1 ul li {
      margin: 0; }
  .content-main .so-spotlight4 .block-product .owl-carousel .owl-dots {
    display: block;
    position: absolute;
    right: 50%;
    bottom: -20px;
    transform: translateX(50%); }
    .content-main .so-spotlight4 .block-product .owl-carousel .owl-dots .owl-dot {
      display: inline-block;
      width: 12px;
      height: 12px;
      border: 2px solid #cccccc;
      margin: 6px; }
      .content-main .so-spotlight4 .block-product .owl-carousel .owl-dots .owl-dot:hover, .content-main .so-spotlight4 .block-product .owl-carousel .owl-dots .owl-dot.active {
        background: #f02034;
        border-color: #f02034; }
.content-main .so-spotlight5 {
  padding: 50px 0; }
  .content-main .so-spotlight5 .collections {
    margin: 0 -10px; }
    .content-main .so-spotlight5 .collections .collection {
      width: 20%;
      float: right;
      display: inline-block;
      padding: 0 10px; }
      .content-main .so-spotlight5 .collections .collection a {
        text-align: center; }
        .content-main .so-spotlight5 .collections .collection a .img-collection {
          position: relative; }
          .content-main .so-spotlight5 .collections .collection a .img-collection:before {
            content: "";
            position: absolute;
            width: 100%;
            height: 100%;
            ...
            right: 0;
            background: inherit; }
        .content-main .so-spotlight5 .collections .collection a h4 {
          font-size: 18px;
          text-transform: uppercase;
          font-weight: 700; }
        .content-main .so-spotlight5 .collections .collection a:hover .img-collection {
          background: rgba(225, 225, 225, 0.4); }
.content-main .so-spotlight6 .brand .item-brand:hover {
  box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); }

@media (max-width: 1199px) {
  .product-layout .product-item-container .left-block .hover-1 ul .icon-search {
    display: none !important; }
...
@media (max-width: 991px) {
  .content-main .so-spotlight4 .block-product {
    width: 100%; } }
@media (max-width: 767px) {
  .content-main .so-spotlight1 .owl-loaded .owl-nav {
    display: none; }
  .content-main .so-spotlight2 .policy-detail .banner-policy .policy {
    width: 100%;
    padding: 20px 0; }
